...
const ProjectCard = ({ project }: { project: Project }) => {
  ...
  return (
    <a
      ...
      className="glass card-glow sheen group relative block overflow-hidden rounded-[28px] p-4"
      style={{ transformStyle: 'preserve-3d' }}
    >
      <div className="media-zoom aspect-[4/3] rounded-2xl mb-6 relative">
      ...
      <div className="tilt-layer px-2 sm:px-3 pb-3">
        ...
        <span className="inline-flex items-center gap-2 text-cyan-400 text-sm font-bold group-hover:gap-3 transition-all">
          {project.cta} <ArrowRight className="w-4 h-4" />
        </span>
      </div>
    </a>
